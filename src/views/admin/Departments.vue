    ...
    <a-drawer placement="right" @close="onClose" :visible="visible" :width="500" theme="dark">
      ...
      <a-form>
        ...
        <a-form-item
          ...
          :extra="office.admin?'Are you sure you want this new office to have Administrator priviledges? System Administrators can modify the application settings. If you want to continue, hit the submit button otherwise set the System Administrator flag back to NO.':''"
        >
          <!-- <a-textarea placeholder="Description" v-model="office.description" :rows="5"></a-textarea> -->
          <a-switch
            checkedChildren="YES"
            unCheckedChildren="NO"
            :checked="office.admin"
            @click="office.admin=!office.admin"
          ></a-switch>
        </a-form-item>
        <a-form-item>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.edit_mode) {
        this.$http
          .post(`/departments/${this.office._id}`, this.office)
          .then(result => {
