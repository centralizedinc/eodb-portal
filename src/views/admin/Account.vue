          ...
          <a-col :span="18" >
              ...
              <div style="border: none; height: 20vh; width: 100%; background:center;background-repeat: no-repeat;background-size: cover; background-image: url('https://picsum.photos/300');"> 
                ...
                <a-row type="flex" justify="start" align="middle">
                    ...
                    <span style="font-size:12px; color: #FFFFFF">{{role.name}}</span><br>           
                    <span style="font-size:12px; color: #01ACAC;">{{department.name}}</span><br>          
                    </a-col>
                </a-row>  
            ...
            <a-form style="margin-top:2vh">
                  ...
                  <a-form-item label="Email" extra="This serves as your username and primary contact information.">
