<template>
  <a-card style="background-color: #242B30;border-radius:10px">
    <a-row type="flex" align="middle">
      <a-col :span="24">
        <span style="color:#B6C2C9; font-weight:bold"
          >INBOX <a-icon type="exclamation-circle"></a-icon
        ></span>
      </a-col>
      <a-col :span="14" style="margin-top:3vh">
        <h2 style="color: #FFFFFF">
          <a-icon type="inbox" style="font-size:32px"></a-icon>
          {{ Math.floor(Math.random() * 12345) }}
        </h2>
        <span style="color:#B6C2C9; font-size:10px; "
          ><a-icon type="up"></a-icon> {{ Math.floor(Math.random() * 50) }}%
          compare to last week</span
        >
      </a-col>
      <a-col :span="10">
        <apexchart
    ...
    <a-row>
      ...
      <a-col :span="16">
        <span style="color:#B6C2C9; font-size:12px">Occupancy Permit</span>
      </a-col>
      <a-col :span="6">
        <span style="color:#FFFFFF; font-weight: bold">{{
          Math.floor(Math.random() * 12345)
    ...
    <a-row>
      ...
      <a-col :span="16">
        <span style="color:#B6C2C9; font-size:12px">Building Permit</span>
      </a-col>
      <a-col :span="6">
        <span style="color:#FFFFFF; font-weight: bold">{{
          Math.floor(Math.random() * 12345)
    ...
    <a-row>
      ...
      <a-col :span="16">
        <span style="color:#B6C2C9; font-size:12px">Sanity Clearance</span>
      </a-col>
      <a-col :span="6">
        <span style="color:#FFFFFF; font-weight:bold">{{
          Math.floor(Math.random() * 12345)
