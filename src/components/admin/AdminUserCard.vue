<template>
  <a-card style="background-color: #242B30;border-radius:10px">
            <a-row type="flex" align="middle">
              <a-col :span="24">
                  <span style="color:#B6C2C9; font-weight:bold">ADMIN USERS   <a-icon type="exclamation-circle"></a-icon></span>                  
              </a-col>
               <a-col :span="14" style="margin-top:3vh">
                <h2 style="color: #FFFFFF"><a-icon type="solution" style="font-size:32px"></a-icon> {{Math.floor(Math.random()* 12345)}}</h2>
            ...
            <a-row>
                ...
                <a-col :span="16">
                    <span style="color:#B6C2C9; font-size:12px">Active</span>
                </a-col>
                <a-col :span="6">
            ...
            <a-row>
                ...
                <a-col :span="16">
                    <span style="color:#B6C2C9; font-size:12px">In-Active</span>
                </a-col> 
                <a-col :span="6">
                    <span style="color:#FFFFFF; font-weight: bold">{{Math.floor(Math.random()* 12345)}}</span>
                </a-col>
